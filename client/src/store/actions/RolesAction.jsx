...
export const createRole = (roleID, roleName) => async (dispatch) => {
  try {
    ...
    const response = await axios.post(`${BASE_URL}${ROLE_URL}`, { roleID, roleName });
    dispatch({ type: ActionTypes.CREATE_ROLE_SUCCESS, payload: response.data });
  } catch (error) {
    dispatch({ type: ActionTypes.CREATE_ROLE_FAIL, payload: error.response?.data || error.message });
  }
};
...
export const fetchRoles = () => async (dispatch) => {
  try {
    ...
    dispatch({ type: ActionTypes.FETCH_ROLES_FAILURE, payload: error.response?.data || error.message });
  }
};
...
export const deleteRole = (roleIds) => async (dispatch) => {
  try {
    ...
    dispatch({ type: ActionTypes.DELETE_ROLE_FAILURE, payload: error.response?.data || error.message });
  }
};
...
export const updateRole = (roleId, updatedData) => async (dispatch) => {
  try {
    ...
    dispatch({ type: ActionTypes.UPDATE_ROLE_FAILURE, payload: error.response?.data || error.message });
  }
};